 ...
 * below and use WordPress's wp_localize_script() to set GENESIS_ADVANCED_DIST_PATH global.
 * Example:
 *   wp_localize_script('genesis-advanced/main.js', 'GENESIS_ADVANCED_DIST_PATH', get_theme_file_uri('dist/'))
 */
